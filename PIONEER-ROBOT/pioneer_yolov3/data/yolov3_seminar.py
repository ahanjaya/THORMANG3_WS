            ...
            if detections is not None:
                ...
                for x1, y1, x2, y2, obj_id, cls_pred in tracked_objects:
                    ...
                    if cls == 'keyboard':
                        ...
                        #     cv2.line(frame,   tuple(left_mid),  tuple(right_mid), (255,0,0), 2)
                        #     cv2.circle(frame, tuple(left_mid),  5, (255,255,255),   -1)
                        #     cv2.circle(frame, tuple(right_mid), 5, (255,255,255),   -1)
